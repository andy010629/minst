...
async function updatePredictions() {
    ...
    // const idx = predictions.indexOf(Math.max(predictions))
    // let prediction_res = document.querySelector('#prediction_res')
    ...
    prediction_res.innerHTML = `${idx}(${Math.round(max*100)}%)`
}
